<%-- 
    Document   : Category
    Created on : Oct 26, 2021, 1:03:37 PM
    Author     : pc
--%>
                    ...
                    <table border="1" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="ControllerCategory?service=delete&cid=<%=rs.getInt(1)%>">Delete</a></td>
                                <td><a href="ControllerCategory?service=update&cid=<%=rs.getInt(1)%>">Update</a></td>
                            </tr>
                            <%}%>
                        </tbody>
                        <a href="ControllerCategory?service=add">Add Category</a>
                    </table>
                </div>
                <div id="sidebar">
