<%-- 
    Document   : update
    Created on : Oct 21, 2021, 12:50:46 PM
    Author     : pc
--%>
        ...
        <div id="content">
            <div id="blog">
                <div id="articles">
                    ...
                    %>
                    <%if (rs.next()) {%>
                    <form action="ControllerBill_Detail?service=update" method="POST">
                        <table border="1">
                            <tr>
                                <td>Product ID</td>
                            ...
                            <tr>
                                <td>Order ID</td>
                                <td><input type="text" name="oID" value= "<%=rs.getString(2)%>"/></td>                   
                            </tr>
                            <tr>
                                <td>Quantity</td>
                            ...
                            <tr>
                                <td>Total</td>
                                <td><input type="text" name="total" value= "<%=rs.getDouble(5)%>"/></td>                   
                            </tr>
                            <tr>
