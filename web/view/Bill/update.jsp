<%-- 
    Document   : update
    Created on : Oct 19, 2021, 3:24:43 PM
    Author     : pc
--%>
        ...
        <div id="content">
            <div id="blog">
                <div id="articles">
                    ...
                    %>
                    <%if (rs.next()) {%>
                    <form action="ControllerBill?service=update" method="POST">
                        <table border="1">
                            <tr>
                                <td>Order ID</td>
                            ...
                            <tr>
                                <td>Date Create</td>
                                <td><input type="text" name="date" value="<%=rs.getString(2)%>" /></td>                  
                            </tr>
                            <tr>
                                <td>Customer Name</td>
                            ...
                            <tr>
                                <td>Total</td>
                                <td><input type="text" name="total" value="<%=rs.getDouble(6)%>" /></td>                  
                            </tr>
                            <tr>
                                <td>Status: </td>
                                <td><input type="radio" name="status" value="1" <%=(rs.getInt(7) == 1 ? "checked" : "")%>/> Delivery</td>
                                <td><input type="radio" name="status" value="0"<%=(rs.getInt(7) == 0 ? "checked" : "")%> /> Done</td>
                            </tr>
                            <tr>
                                <td>Customer ID</td>
                                <td><input type="text" name="cid" value="<%=rs.getInt(8)%>" /></td>                   
                            </tr>
                            <tr>
